...
import type { Invoice } from 'zugferd-validator'

// A copy of packages/zugferd-validator/tests/checks/fixtures.ts's
// makeInvoice, not a shared import -- these tests sit on the app side of
// the package boundary (review/ stays app-specific, see CLAUDE.md), and
// reaching into another workspace's tests/ directory would couple this
// app's test suite to the package's internal file layout.
